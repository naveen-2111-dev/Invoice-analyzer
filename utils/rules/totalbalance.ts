...
export async function TotalBalance(invoices: Partial<Invoice>[]): Promise<{ rule: string; results: TotalBalanceFindings[] }> {
    ...
    return { rule: "TOTALS_BALANCE", results: findings };
}
